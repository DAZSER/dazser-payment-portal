...
exports.default = (function (initAmount) {
    ...
    var displayTotal = Number.parseFloat(totalCharge.div(100).toString()).toLocaleString("en-US", options);
    var displayFee = Number.parseFloat(fee.div(100).toString()).toLocaleString("en-US", options);
    var displayAmount = Number.parseFloat(amount.div(100).toString()).toLocaleString("en-US", options);
    return {
...
amountInput.addEventListener("keyup", function () {
    if (amountInput.value !== "") {
        ...
        var amounts = fee_1.default(Number.parseFloat(amountInput.value.replace(/[^\d.-]+/g, "")));
